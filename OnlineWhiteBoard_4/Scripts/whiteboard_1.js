...
function DrawIt(drawObject, syncServer) {
    ...
    context.fillStyle = drawObject.Color;
...
tools.text = function () {
    ...
    this.mousedown = function (ev) {
        if (!tool.started) {
            ...
            drawObject.StartX = ev._x;
            drawObject.StartY = ev._y;
            var text_to_add = prompt('Введите текст:', ' ', 'Add Text');
            drawObject.Text = "";
